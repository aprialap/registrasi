...
@section('title')
    <title>Admin | Tambah Pasien</title>    
@endsection
@section('content')
        ...
        <div class="row">
            <div class="col-4"> 
                <div class="mb-3">
                    ...
                    <input type="text" name="no_rm" class="form-control form-control-sm" value="{{old('no_rm')}}" required>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-4"> 
                <div class="mb-3">
                    ...
                    <input type="text" name="nik" class="form-control form-control-sm" value="{{old('nik')}}" required>
                </div>
            </div>
        </div>
            ...
            <div class="col-4"> 
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Ibu Kandung</label>
                       <input type="text" name="ibu_kandung" class="form-control form-control-sm" value="{{old('ibu_kandung')}}" required>
                </div>
            </div>
        </div>
            ...
            <div class="col-8"> 
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Alamat</label>
                      <textarea name="alamat" class="form-control form-control-sm" cols="30" rows="5" required>{{old('alamat')}}</textarea>
                </div>
            </div>
        </div>
