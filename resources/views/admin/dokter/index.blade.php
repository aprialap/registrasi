      ...
      <div class="card shadow mb-4">
          <div class="card-header py-3">
              ...
              <div class="col-md-12 text-right">
                <a  href="{{route('dokter.create')}}" class="btn btn-sm btn-success" title="Tambah Data"><i class="nav-icon fas fa-plus"></i> Tambah Data</a>
              </div>
          </div>
          <div class="card-body">
                      ...
                      <tbody>
                        @forelse ($data as $item)
                         <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{route('dokter.edit', $item->id)}}" class="btn btn-primary btn-sm"><i class="nav-icon fas fa-edit"></i></a>
                                    <a href="{{route('dokter.destroy', $item->id)}}" class="btn btn-danger btn-sm tombol-hapus"><i class="nav-icon fas fa-trash"></i></a>
                                </div>
                            </td>  
                          </tr>
                          @empty
